...
vignette: >
  %\VignetteIndexEntry{Generate Posterior Simulations}
...
then fit BFACT to evaluate model sensitivity.

**Workflow**:

1. Extract posterior samples from a model fitted to real data (e.g., $H_0 = 2$)
