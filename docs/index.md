...
- [Fitting BFACT to Real Climate
  Data](https://shalenik.github.io/BFACT/articles/01-fit-real-data.md) -
  Learn how to fit the BFACT model to real temperature anomaly data
- [Generate Posterior
  Simulations](https://shalenik.github.io/BFACT/articles/02-posterior-simulation.md) -
  Work with posterior samples and synthetic data generation
- [Model Selection Across Multiple
  Replications](https://shalenik.github.io/BFACT/articles/03-multiple-replicates.md) -
...
- [`BFACT()`](https://shalenik.github.io/BFACT/reference/BFACT.md) - Core
